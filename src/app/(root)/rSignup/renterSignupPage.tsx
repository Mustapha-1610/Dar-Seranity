    ...
    <>
      <div>
        <Spin spinning={loading} delay={500}>
          ...
          <button className="w-full max-w-xs  font-bold mt-1 shadow-sm rounded-lg py-3  text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
          ...
          <p className="mb-2 text-gray-500 italic items-center justify-center text-center">
