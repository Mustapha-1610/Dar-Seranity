  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `url('https://i.pinimg.com/originals/29/7d/5c/297d5cdc10322838adc7ca198f186f72.jpg')`,
          ...
          <div className="container mx-auto py-8">
            <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
              <div className="col-span-4 sm:col-span-3">
                <div className="[hsla(0,0%,50%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,2%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[50px] backdrop-blur-[50px] shadow rounded-lg p-6">
                  ...
                  <div className="flex text-gray-300 flex-col">
                    ...
                    <ul>
                      ...
                      <li className="mb-2">Anguler Js</li>
              ...
              <div className="col-span-4 [hsla(0,0%,110%,0.8)] shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[70px] backdrop-blur-[30px] sm:col-span-9">
                <div className="[hsla(0,0%,110%,0.8)]   shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-5 -mt-[20px] backdrop-blur-[30px] rounded-lg p-6">
                  ...
                  <h3 className="font-semibold text-white bold text-center mt-3 -mb-2">
                    Find me on
                  </h3>
                  <div className="flex justify-center items-center gap-6 my-6">
                    ...
                    <a
                      className="text-gray-700 hover:text-purple-300"
