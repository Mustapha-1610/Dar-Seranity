...
export const sendRenterReminderMail = async (
  name: string,
  email: string,
...
export const sendRentPaymentDueMails = async (
  name: string,
  email: string,
  propertyTitle: string,
  paymentDate: string
  ...
  <div style="text-align: center; margin-bottom: 5px;">
    <h3>Hello ${name}, Your Rent Payment For Property : ${propertyTitle} Is Due In 3 Days  </h3>
